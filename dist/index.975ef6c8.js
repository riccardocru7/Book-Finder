...
})({"6X1Gc":[function(require,module,exports,__globalThis) {
...
document.getElementById('searchButton').addEventListener('click', (0, _lodashDefault.default).debounce(async ()=>{
...
document.getElementById('category').addEventListener('keydown', (0, _lodashDefault.default).debounce(async (event)=>{
...
async function searchBooks(category) {
    ...
    try {
        ...
        if (response.data.totalItems > startIndex) showLoadMoreButton(category);
...
},{"axios":"jo6P5","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}]},["6X1Gc","8lqZg"], "8lqZg", "parcelRequire94c2")
